...
NUST_raw_tall <- read_csv("data/Phenotype_Measures_Final_Master_NUST_1993_2020_years28.csv") #raw phenotypic data in analyzable format
...
infile <- "data/NUST_geno_Wm82.a2_Filt_KNNimp.vcf" #original file
...
# Assign value for the number of cross validations to do
FOLD <- 10
